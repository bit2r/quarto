...
::: {layout="[1, 20]"}
![](fig/presentation-menu.png){width="41"}
...
::: {layout="[1, 20]"}
![](fig/presentation-chalkboard.png){width="41"}

Use the chalkboard button at the bottom left of the slide to toggle the chalkboard.
:::

::: {layout="[1, 20]"}
![](fig/presentation-notes-canvas.png){width="41"}
...
![](fig/speaker-view.png){fig-align="center" style="border: 3px solid #dee2e6;" width="780"}
...
::: columns
::: {.column width="50%"}
![](fig/jupyter-edit.png){.border .border-thick}
:::

::: {.column width="50%"}
![](fig/jupyter-preview.png){.border .border-thick}
:::
:::
...
![](fig/rstudio.png){.border width="900"}
